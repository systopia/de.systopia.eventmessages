...
// Make CRM_Eventmessages_ExtensionUtil available.
require_once __DIR__ . '/../../eventmessages.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.eventmessages');
 ...
 */
function _eventmessages_test_civicrm_container(ContainerBuilder $container): void {
}
